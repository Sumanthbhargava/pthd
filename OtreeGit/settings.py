...
SESSION_CONFIGS = [
    ...
    dict(
        name='cooperate_defect_game', display_name="Cooperate Defect Game", app_sequence=['CDG_intro','cooperate_defect_game'], num_demo_participants=2,  PARTICIPANT_FIELDS=["Total_payoff","Opponent_record"] 
    ),
]
