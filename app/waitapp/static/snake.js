...
(function snake () {
    var SIZE = 250; // Size of the play-field in pixels
    ...
    function tick() {
      ...
      if (end) {
        ...
        context.fillText('Press ENTER to play again', SIZE / 2, SIZE / 2);
      } else {
    ...
    window.onload = function() {
        ...
        var timer = setInterval(tick, 100); // Kick off the game loop!
        ...
        document.onkeypress = function (evt) {
            ...
            if (charCode == 13) {
                    SIZE = 250; // Size of the play-field in pixels
                    GRID_SIZE = SIZE / 50;
                ...
                // Insert Enter handling code here
                clearInterval(timer);
                timer = setInterval(tick, 100); // Kick off the game loop!
